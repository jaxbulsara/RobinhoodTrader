...
def test_login_logout(maintainConfig):
    ...
    assert trader.stockBroker.session == trader.session
    assert trader.cryptoBroker.session == trader.session
    ...
    assert trader.stockBroker.session == None
    assert trader.cryptoBroker.session == None
